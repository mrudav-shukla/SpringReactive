package com.baeldung.reactive.stockclient.controller;
...
import com.baeldung.reactive.stockclient.model.Stock;
...
public class StockRateClientController {
	...
	private WebClient webClient = WebClient.create("http://localhost:8082/server/stocks");
