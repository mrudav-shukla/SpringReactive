package com.baeldung.reactive.stockserver.controller;
...
import com.baeldung.reactive.stockserver.service.StockRateService;
...
public class StockRateServerController {
	...
	public Flux<Stock> getLiveStockRates(@PathVariable("stockName") final String stockName) {
